...
<body class="antialiased overflow-x-hidden grid-pattern">
            ...
            <div class="p-8 mb-4">
                <div class="flex items-center gap-4 group cursor-pointer">
                    <div class="w-12 h-12 relative flex-shrink-0 overflow-hidden rounded-full bg-white p-1">
                        <img src="<?php echo e(asset('images/voltspace-logo.png')); ?>" alt="VoltSpace Logo" class="w-full h-full object-contain" width="48" height="48" decoding="async">
                    </div>
            ...
            <nav class="flex-1 min-h-0 px-4 space-y-1.5 overflow-y-auto custom-scrollbar">
                <?php
                    $menu = [
                        ...
                        ['id' => 'devices', 'label' => 'Devices', 'icon' => 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4'],
                        ['id' => 'schedule', 'label' => 'Electricity Schedule', 'icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'],
                ...
                <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($item['route'] ?? '#'); ?>" class="flex items-center justify-between px-4 py-3 rounded-xl transition-all group <?php echo e((request()->is(ltrim($item['route'] ?? '', '/'))) ? 'nav-item-active' : 'text-slate-400 hover:text-white hover:bg-[#1e293b]'); ?>">
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path d="<?php echo e($item['icon']); ?>"/></svg>
                            <span class="text-[15px] font-medium"><?php echo e($item['label']); ?></span>
                        </div>
                        <?php if(isset($item['badge'])): ?>
                            <span class="w-5 h-5 rounded-full bg-red-500/20 text-red-500 text-[10px] font-bold flex items-center justify-center"><?php echo e($item['badge']); ?></span>
                        <?php endif; ?>
                    </a>
    ...
    <?php echo $__env->make('partials.voltspace-api', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html>
<?php /**PATH D:\Telkom University\Materi Kuliah Semester 6\Proyek Perangkat Lunak\project_ppl-main\resources\views/layouts/main.blade.php ENDPATH**/ ?>