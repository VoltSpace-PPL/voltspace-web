...
<div class="rounded-2xl overflow-hidden transition-all hover:border-slate-500"
    ...
    {{-- Card Header --}}
    <div class="px-6 py-4 flex items-center justify-between gap-3 border-b" style="border-color:#1e2d45;">
    ...
    {{-- Footer --}}
    <div class="px-6 py-3 flex items-center justify-between border-t" style="border-color:#1e2d45;">
